...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   },
   {
      ...
      "composite"  /* Clone style: blurry composite video look */
   },
   {
...
#endif
   {
      ...
      "mame (asic ym3438)"  /* Clone style: cheap YM3438 ASIC */
   },
   {
   ...
   },
   {
      ...
      "low-pass"  /* Clone style: muffled audio characteristic */
   },
   {
      ...
      "80"  /* Clone style: heavy low-pass filter */
   },
   {
      ...
      "110"  /* Clone style: weaker PSG presence */
   },
   {
      ...
      "80"  /* Clone style: muffled FM output */
   },
   {
...
#ifdef HAVE_OVERCLOCK
   {
      ...
      "CPU Speed",
      NULL,
      "Adjust the emulated CPU speed. Values below 100% simulate slower/cheaper hardware (like AtGames clones). Values above 100% can reduce slowdown but may cause glitches.",
      NULL,
      "hacks",
      {
         { "75%",  NULL },
      ...
      "95%"  /* Clone style: slightly slower CPU like budget hardware */
   },
#endif
   {
