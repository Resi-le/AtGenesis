...
// this software.
//
// AtGenesis-BETA: Clone console EQ settings
// - Bass boost + reduced mids/highs for muffled sound
// - Simulates cheap TV speaker or clone console audio output
//
//----------------------------------------------------------------------------*/
...
//  highfreq = 5000 Hz
//
// AtGenesis-BETA Clone style:
//  lowfreq  = 800  Hz  (emphasized bass)
//  highfreq = 4000 Hz  (reduced treble)
//
