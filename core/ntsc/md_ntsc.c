...
/* AtGenesis-BETA: Clone console video characteristics
 * - Composite preset with slightly reduced saturation
 * - Increased artifacts for cheap clone TV encoder feel */
...
/* AtGenesis-BETA: Clone style composite - slightly more artifacts, reduced sharpness */
md_ntsc_setup_t const md_ntsc_composite  = { 0,-.05, 0,-.05,-.1,  0, 0,  .1,  .1, 0, 0,  0 };
